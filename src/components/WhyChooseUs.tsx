...
const WhyChooseUs = () => {
  ...
  return (
    <section id="about" className="py-20 bg-black relative overflow-hidden">
      ...
      >
        <div className="absolute top-20 left-10 w-24 h-24 border border-yellow-400/10 rotate-45"></div>
        <div className="absolute bottom-20 right-10 w-32 h-32 border border-yellow-400/8 rounded-full"></div>
        <div className="absolute top-1/2 left-1/4 w-20 h-20 bg-yellow-400/5 rotate-12"></div>
      </div>
